...
var getBarChartData = function getBarChartData(apiData, selectedState) {
  ...
  var tmpList = list.filter(function (x) {
...
var getChartData = function getChartData(chartType, apiData) {
  ...
  var sliced = apiData.slice(-40); //console.log("Api data", sliced);
  ...
  return {
    ...
    datasets: [(_ref = {
      ...
      pointHoverBorderColor: "rgba(220,220,220,1)",
      pointBorderWidth: 1
    }, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref2, "pointHoverRadius", 5), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref2, "borderColor", "lime"), Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])(_ref2, "data", sliced.map(function (it) {
...
//# sourceMappingURL=index.js.09028a82e67358d192cd.hot-update.js.map